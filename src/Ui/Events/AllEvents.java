...
/////////////////////////////////////////////////////////////////////UI WALA PART/////////////////////////////////////////////////////////////////////////////////////////
        ...
        FindPlaces.setFill(Color.RED);
        FindPlaces.setX(MainPainX+150);
        FindPlaces.setY(550);
        FindPlaces.setScaleX(3);
        FindPlaces.setScaleY(2);
        FindPlaces.setFont(Font.font("Verdana",FontPosture.ITALIC, 12));
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        Home.setLayoutX(80);
        Home.setLayoutY(170);
        Home.setPrefHeight(100);



        Button BookEvents =  new Button("BOOK EVENT");
        BookEvents.setLayoutX(60);
        BookEvents.setLayoutY(250);
        BookEvents.setPrefHeight(100);
        ///////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////UI WALA PART ENDS/////////////////////////////////////////////////////////////////////////////////////////
        ...
        Home.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                // Directing to Home Page UI created by Harman
            }});

        BookEvents.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
               // AnchorPane AllEvents = FunctionAllEvents();
            }});
